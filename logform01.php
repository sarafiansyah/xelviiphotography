      ...
      <section id="formHolder">
         ...
         <div class="row">
            ...
            <div class="col-sm-6 brand">
               <a href="#" class="logo">XELVII Public</a>
            ...
            <div class="col-sm-6 form">
               ...
               <div class="signup form-peice">
                  <form class="" action="#" method="post">
                     ...
                     <div class="form-group d-none" style="color: black;">
                        <label for="date_joined">Join Date</label>
                        <input type="text" name="join_time" id="join_time" class="" value="<?php echo date("d/m/Y"); ?>">
                        <span class="error"></span>
                     </div>
                     <div class="form-group d-none" style="color: black;">
                        <label for="time_joined">Join Time</label>
                        <input type="text" name="join_date" id="join_date" class="" value="<?php date_default_timezone_set("Asia/Jakarta");
                                                                                             echo date("H:i:s") . " GMT+7";  ?>">
                        <span class="error"></span>
                     </div>
