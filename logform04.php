...
<body>
  ...
  <div class="col-12 col-md-12 col-xxl-12  text-light text-justify homebg1" id="home" style="padding-bottom: 200px; padding-top: 200px">
    <div class="container">
      <div>
        <h1 style="font-size: 48px;" class="mb-5 text-uppercase text-center" data-aos="fade-right" id="maintitle">login to access more contents!</h1>



        <div class="mx-auto justify-content-center text-center" data-aos="fade-left">
          <p class="intro text-center" style="font-size: 24px;">Kamu perlu Sign Up atau Login terlebih dahulu <br>untuk mengakses konten XELVII lebih banyak!</p>

          <a href="logform02.php" style="text-decoration: none;" class="btn  btn-outline-light text-light" tabindex="-1" role="button" aria-disabled="true" style="color: white;">Login</a>
          <a href="logform01.php" style="text-decoration: none;" class="btn  btn-light " tabindex="-1" role="button" aria-disabled="true" style="color: white;">Sign Up</a>
