  ...
  <div id="navbarCollapse" class="collapse navbar-collapse justify-content-end">
    <div class="navbar-nav">
      ...
      <div class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          <a href="admin/index.php?page=public-db" class="dropdown-item">XELVII Public</a>
          <a href="admin/index.php?page=public-db" class="dropdown-item">XELVII Admin</a>

        </div>
      </div>

      <a href="admin/index.php?page=feedback-db" class="nav-item nav-link active">Feedbacks</a>
      <a href="help.php" class="nav-item nav-link active">Reports</a>
