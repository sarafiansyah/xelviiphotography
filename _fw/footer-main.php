<footer
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <hr
                ...
                />
            <p>
              <a href="index.html#home" class="text-white">Home</a>
            </p>
            <p>
              <a href="index.html#about" class="text-white">About</a>
            </p>
            <p>
              <a href="index.html#rating" class="text-white">Ratings</a>
            </p>
            <p>
              <a href="profile.html" class="text-white">Credits</a>
            </p>
          </div>
          <!-- Grid column -->
    ...
    <div
      ...
      <a class="text-white" href="index.php#home"
         >© 2022 XELVII.com . All Rights Reserved.</a
        >
    </div>
    <!-- Copyright -->
  </footer>