        ...
        <div class="homebg1" id="home">
          <div class="col-12 col-md-12 col-xxl-12  text-light text-justify " style="padding-top: 100px; padding-bottom: 100px;">
            <div class="container">
              ...
              <div class="">
                <h2 class="text-center mb-3"><strong>XELVII USERS REVIEW</strong></h2>
                <table class="table table-light table-striped table-hover text-center">
                  ...
                  <tbody>
                    <?php
                    $result = $conn->query("SELECT * FROM users_feedback;");
                    //var_dump($rows);
                    while ($row = $result->fetch_assoc()) {
                      ...
                      echo "<td><a href='index.php?page=delete_fb&id=$row[review_id]' class='btn btn-danger'><i class='fas fa-trash'></i> Delete</a></td>";
                      echo "</tr>";
                    }
