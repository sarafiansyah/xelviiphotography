    ...
    <div class=""> 
      ...
      <div class="homebg1" id="home"  >
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  ...
                  <div  style="margin-top: 180px; ">
                    <h1 class="mb-5 text-uppercase home1title " data-aos="fade-up" data-aos-duration="1500" id="maintitle">ADMIN</h1>          
       ...
       <div class="aboutText ">
        ...
        <div class="container ">
          <h1 class="mb-5 text-uppercase text-light text-justify" data-aos="fade-right"  style="font-family: 'Raleway', sans-serif;">YOUR PHOTOGRAPHY STYLE</h1>
        ...
        <div class="slider owl-carousel">
          <div class="card cardOWL">
             <div class="img">
                <img src="https://i.ytimg.com/vi/_E0QnZJVMSA/maxresdefault.jpg"  style="border-radius: 10px" alt="">
             </div>
             <div class="content">
                <div class="title">
                   D-SLER
          ...
          <div class="card cardOWL">
             <div class="img">
                <img src="https://images.unsplash.com/photo-1584006682522-dc17d6c0d9ac?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1035&q=80" style="border-radius: 10px" alt="">
             </div>
             <div class="content">
                <div class="title">
                   SMARTPHONER
          ...
          <div class="card cardOWL">
             <div class="img">
                <img src="https://images.unsplash.com/photo-1551232865-e0a56728e881?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=871&q=80" style="border-radius: 10px" alt="">
             </div>
             <div class="content">
                <div class="title">
                  VINTAGER
          ...
          <div class="card cardOWL">
             <div class="img">
                <img src="https://images.unsplash.com/photo-1542038784456-1ea8e935640e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" style="border-radius: 10px" alt="">
             </div>
             <div class="content">
                <div class="title">
                   NEWCOMER
...
<div class="" data-aos="fade-up">
    ...
    <div class="mb-3 d-none">
      ...
      <input type="text" id="disabledTextInput" class="form-control" placeholder="" name="time_posted" 
      value="<?php date_default_timezone_set("Asia/Jakarta"); echo date("H:i:s"); ?>">
      
    </div>
    <div class="mb-3 d-none">
      <label for="disabledTextInput" class="form-label">Date</label>
      <input type="text" id="disabledTextInput" class="form-control" placeholder="" name="date_posted" 
