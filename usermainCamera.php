<div id="secCamera" class="" style="padding-top: 50px; padding-left: 60px; padding-bottom: 100px; ">
    ...
    <div class="" data-aos="fade-up">
        ...
        <button type="button" class="btn btn-primary rounded-pill" onclick="window.location.href='camera.php'">PELAJARI LEBIH LANJUT</button>
