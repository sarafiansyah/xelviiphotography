...
<body>
    ...
    <div class="homebg1" id="home">
        <div class="container" style="padding-top: 100px;">
            <h1 class="mb-5 text-uppercase home1title " style="color: white;" id="maintitle">RATINGS & REVIEWS</h1>
            <div class="card">
                <div class="card-header">XELVII.com</div>
                <div class="card-body">
                    <div class="row">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="user_name" id="user_name" class="form-control" placeholder="Enter Your Name" value="<?php echo $showdata['nama_depan'] . " " . $showdata['nama_belakang'] ?>" />
                </div>
                <div class="form-group">
                    <label for="user_review">My Review</label>
